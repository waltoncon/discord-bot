 ...
 */
class MoveWaintingUsers extends DiscordEvents_1.DiscordVoiceStateUpdateEvent {
    handle() {
        ...
        if (this.newMember.voiceChannel.id === process.env.VOICE_PRIMARY_ID) {
            ...
            // let movedUsers =
            const members = waitingChannel.members.map((member) => __awaiter(this, void 0, void 0, function* () {
