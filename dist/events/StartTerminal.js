...
const handle = (client) => __awaiter(void 0, void 0, void 0, function* () {
    readline.on('SIGINT', () => {
        Log_1.default.warn('\nExiting');
        process.exit();
    });
    yield readline.question('> ', (input) => __awaiter(void 0, void 0, void 0, function* () {
        input = input.trim();
        if (input === "exit") {
        ...
        if (Object.keys(Commands_1.default).includes(name)) {
            try {
                yield new Commands_1.default[name](input, { client }).handle();
            }
            catch (e) {
